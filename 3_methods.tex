...
\subsubsection{Convoluzione} % (fold)
...
% subsubsection convoluzionale (end)

\subsubsection{Max pooling} % (fold)
...
% subsubsection Bridge (end)

\subsubsection{Decoder} % (fold)
\label{sec:Decoder}
...
\subsection{Rimozione sliding window} % (fold)
...
% subsection Rimozione sliding window (end)


\subsection{Modifica encoding e decoding} % (fold)
...
% subsection Modifica encoding e decoding (end)
