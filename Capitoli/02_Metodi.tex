...
\todo{Approfondire spiegazioni anche con aggiunta di immagini}
...
La Binary Cross-Entropy (BCE) Loss è una delle funzioni di perdita più comuni
utilizzate nei problemi di classificazione binaria. È particolarmente utile
quando i dati di output sono probabilità che variano tra 0 e 1. La BCE Loss
misura quanto le predizioni fatte dal modello si discostano dai veri valori
(etichette).
